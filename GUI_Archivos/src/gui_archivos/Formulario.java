...
public class Formulario extends JFrame {
    ...
    public void guardar(){
        ...
        int d,m,a,edad,cd,cm,ca;
        d = m = a = edad = cd = cm =ca = 0;
        try {
            d = Integer.parseInt(campos[3].getText());
            m = Integer.parseInt(campos[4].getText());
            a = Integer.parseInt(campos[5].getText());
            cd = Calendar.getInstance().get(Calendar.DAY_OF_MONTH);
            cm = Calendar.getInstance().get(Calendar.MONTH) + 1;
            ca = Calendar.getInstance().get(Calendar.YEAR);
            edad = ca - a + (cm >= m && cd >= d ? 1 : 0);
        ...
        if (!error && !exits(campos[2].getText())) {
            ...
            try {
                w.write(campos[2].getText()+";"+campos[0].getText()+";"+campos[1].getText()+";"
                        +d+"/"+m+"/"+a+";"+edad+";"+cd+"/"+cm+"/"+ca+";"+boxes[2].getSelectedItem()+";"+
